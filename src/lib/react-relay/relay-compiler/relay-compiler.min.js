...
module.exports = function (e) {
  ...
  function _(e) {
    return e instanceof s || e instanceof o || r(!1), e;
  }
  ...
  e.exports = {
    ...
    hasID: function (e, n) {
      var t = k(n);
      t instanceof s || t instanceof o || r(!1);
      var a = e.getType(g),
          i = t.getFields()[h];
      return i && k(i.type) === a;
    },
  ...
  function h(e) {
    var n = o[e];
    "b" !== n.ph ? ("B" !== n.ph && a(!1), l.pop() !== n && a(!1), n !== o[o.length - 1] ? o.push({
      ph: "E",
      name: n.name,
      pid: n.pid,
      tid: n.tid,
  ...
  var r = t(8),
      ...
      v = i.UniqueOperationNamesRule,
      h = i.UniqueVariableNamesRule,
      g = i.ValuesOfCorrectTypeRule,
      y = i.VariablesAreInputTypesRule,
      b = i.formatError,
      k = i.validate;
  e.exports = {
    GLOBAL_RULES: [l, c, d, m, p, v, h],
  ...
  var r = t(0),
    ...
    function e(e, n) {
      ...
      if (this._filesystem = null !== (r = n.filesystem) && void 0 !== r ? r : t(13), this.onlyValidate = n.onlyValidate, this._shards = null !== (a = n.shards) && void 0 !== a ? a : 1, this._filesystem.existsSync(e) && (this._filesystem.statSync(e).isDirectory() || s(!1)), !this.onlyValidate) {
        ...
        if (o.forEach(function (e) {
          ...
          this._filesystem.existsSync(f) ? this._filesystem.statSync(e).isDirectory() || s(!1) : this._filesystem.mkdirSync(f);
        }
      }
  ...
  function p(e, n, t) {
    ...
    var i = a.map(function (e) {
      return function e(n, t, a) {
        ...
        if ("LinkedField" === n.kind) o = v(n, {
          parentDirectives: l,
          isClientExtension: s
        }), o += p(n, t + m, {
          isClientExtension: s
        });else if ("ConnectionField" === n.kind) o = v(n, {
          parentDirectives: l,
          isClientExtension: s
        }), o += p(n, t + m, {
          isClientExtension: s
        ...
        }).join("\n" + t + m);else if ("ScalarField" === n.kind) o = v(n, {
          parentDirectives: l,
          isClientExtension: s
        });else if ("InlineFragment" === n.kind) o = "", s && (o += "# "), o += "... on " + n.typeCondition.toString(), o += l, o += h(n.directives), o += p(n, t + m, {
          isClientExtension: s
        });else if ("FragmentSpread" === n.kind) o = "", s && (o += "# "), o += "..." + n.name, o += l, o += function (e) {
          var n = g(e);
          if (!n.length) return "";
          return " @arguments".concat(n);
        }(n.args), o += h(n.directives);else if ("InlineDataFragmentSpread" === n.kind) o = "# ".concat(n.name, " @inline") + "\n".concat(t).concat(m, "...") + l + p(n, t + m);else if ("Condition" === n.kind) {
          var u = y(n.condition);
          null == u && r(!1);
        ...
        } else "ClientExtension" === n.kind ? (!1 !== s && r(!1), o = "# Client-only selections:\n" + t + m + n.selections.map(function (n) {
          return e(n, t, {
            parentDirectives: l,
            isClientExtension: !0
          });
  ...
  function v(e, n) {
    ...
    return (!0 === (null == n ? void 0 : n.isClientExtension) ? "# " : "") + (e.alias === e.name ? e.name : e.alias + ": " + e.name) + g(e.args) + r + h(e.directives) + function (e) {
      if (!e.handles) return "";
  ...
  function b(e, n) {
    ...
    if (n instanceof f && (n = n.ofType), n instanceof o) {
      var t = n.serialize(e);
      return null == t && "string" == typeof e && (t = e), "string" != typeof t && r(!1), t;
    }
    ...
    if ("object" == typeof e && null != e) {
      ...
      for (var v in e) e.hasOwnProperty(v) && m.push(v + ": " + b(e[v], p[v].type));
      ...
      switch (e.kind) {
        ...
        case "Root":
          return "".concat(e.operation, " ").concat(e.name) + function (e) {
            ...
            return n.length ? "(\n".concat(m).concat(n.join("\n" + m), "\n)") : "";
          }(e.argumentDefinitions) + h(e.directives) + p(e, "") + "\n";
  ...
  var r = t(0),
      ...
      V = y.print,
      M = y.Source,
      j = new Set(["argumentDefinitions", "uncheckedArguments_DEPRECATED", "arguments"]);

  function P(e, n) {
    var t = L(e, n);
    if (!N(t)) throw v("Unknown type: '".concat(V(n), "'."), null, [n]);
    return t;
  }
  ...
  var q = function () {
    ...
    return n.transform = function () {
      var e,
          ...
          t = [],
          r = new Map();
      if (null == (e = h(this._definitions, function (e) {
        var t = e[0],
            a = e[1],
      ...
      })) && (e = h(r.values(), function (e) {
        var a = e.definition,
            i = e.variableDefinitions,
            o = function (e, n, t, r, a) {
          return new G(e, n, t, r, a).transform();
      ...
      if (1 !== t.length) throw v("Directive @".concat("argumentDefinitions", " may be defined at most once per ") + "fragment.", null, t);
      var r = t[0],
          a = r.arguments;
      if (null == r || !Array.isArray(a)) return new Map();
      if (!a.length) throw v("Directive @".concat("argumentDefinitions", " requires arguments: remove the ") + "directive to skip defining local variables for this fragment.", null, [r]);
      var i = new Map();
      return a.forEach(function (e) {
        var t,
            ...
            o = K(e),
            l = i.get(o);
        if (null != l) throw v("Duplicate definition for variable '$".concat(o, "'."), null, [l.ast, e]);
        if ("ObjectValue" !== e.value.kind) throw v("Expected definition for variable '$".concat(o, "' to be an object ") + "with the shape: '{type: string, defaultValue?: mixed}.", null, [e.value]);
        if (e.value.fields.forEach(function (n) {
          var t = K(n);
          if ("type" === t) a = Q(n.value, n);else {
            if ("defaultValue" !== t) throw v("Expected definition for variable '$".concat(o, "' to be an object ") + "with the shape: '{type: string, defaultValue?: mixed}.", null, [e.value]);
            r = n.value;
          }
        }), "string" != typeof a) throw v("Expected definition for variable '$".concat(o, "' to be an object ") + "with the shape: '{type: string, defaultValue?: mixed}.", null, [e.value]);
        var s = O(a),
            u = k(P(n._schema, s)),
            c = null != r ? U(r, u, function (e) {
          throw v("Expected 'defaultValue' to be a literal, got a variable.", null, [e]);
        }, {
          nonStrictEnums: !0
        }) : null;
        if (null != c && "Literal" !== c.kind) throw v("Expected 'defaultValue' to be a literal, got a variable.", [c.loc]);
        i.set(o, {
          ast: e,
      ...
      return (e.variableDefinitions || []).forEach(function (e) {
        var r = K(e.variable),
            ...
            i = e.defaultValue ? Q(e.defaultValue, e) : null,
            o = t.get(r);
        if (null != o) throw v("Duplicate definition for variable '$".concat(r, "'."), null, [o.ast, e]);
        t.set(r, {
          ast: e,
          defaultValue: i,
          defined: !0,
  ...
  var G = function () {
    ...
    return n.transform = function () {
      ...
      if (null != t) {
        ...
        if (null != r) {
          var a = r.type;
          if (null != r.defaultValue && (a = new C(c(a))), !R(this._schema, a, t)) throw v("Variable '$".concat(n, "' was defined as type '").concat(String(r.type), "' but used in a location expecting the type '").concat(String(t), "'"), null, [r.ast, e]);
        } else {
          ...
          if (i && i.type) {
            var o = i.type,
                l = i.ast;
            if (!R(this._schema, t, o) && !R(this._schema, o, t)) throw v("Variable '$".concat(n, "' was used in locations expecting the conflicting types '").concat(String(o), "' and '").concat(String(t), "'."), null, [l, e]);
            R(this._schema, t, o) && this._unknownVariables.set(n, {
              ast: e,
              type: t
            });
      ...
      if (e && e.length) {
        var t = this._getDirectiveLocations(),
          ...
          if (j.has(r)) return !1;
          var a = t.get(r);
          if (null == a) throw v("Unknown directive '".concat(r, "'."), null, [e]);
        ...
        if (r.length) {
          ...
          throw v("Invalid directives ".concat(a, " found on ").concat(n, "."), null, r);
        }
      }
      ...
      if (!e.selectionSet) throw v("Expected operation to have selections.", null, [e]);

      var i = this._transformSelections(e.selectionSet, n),
          o = W(this._variableDefinitions);

      if (0 !== this._unknownVariables.size) throw v("Query '".concat(r, "' references undefined variables."), null, Array.from(this._unknownVariables.values(), function (e) {
        return e.ast;
      }));
      return {
        kind: "Root",
      ...
      var t = this,
        ...
        return "arguments" === n || "uncheckedArguments_DEPRECATED" === n;
          ...
          i = a[0],
          o = a[1];
      if (i.length > 1) throw v("Directive @".concat("arguments", " may be used at most once per a fragment spread."), null, i);

      var s = this._entries.get(r);

      if (null == s) throw v("Unknown fragment '".concat(r, "'."), null, [e.name]);
      var u,
      ...
      if (null != f) {
        ...
        if (u = (f.arguments || []).map(function (e) {
          ...
          if ("Variable" === i.kind) {
            if (null == o && !d) throw v("Variable @".concat("arguments", " values are only supported when the ") + "argument is defined with @".concat("argumentDefinitions", ". Check ") + "the definition of fragment '".concat(r, "'."), null, [e.value, s.definition]);
            return m = m || null == o, {
              kind: "Argument",
              loc: H(e.loc),
              metadata: null,
          ...
          if (null == l) throw v("Literal @".concat("arguments", " values are only supported when the ") + "argument is defined with @".concat("argumentDefinitions", ". Check ") + "the definition of fragment '".concat(r, "'."), null, [e.value, s.definition]);
        ...
        }), d && !m) throw v("Invalid use of @".concat("uncheckedArguments_DEPRECATED", ": all arguments ") + "are defined, use @".concat("arguments", " instead."), null, [f]);
      }
      ...
      if (null == i) throw v("Unknown field '".concat(a, "' on type '").concat(String(n), "'."), null, [e]);
      ...
      if (A(_(m))) {
        if (e.selectionSet && e.selectionSet.selections && e.selectionSet.selections.length) throw v("Expected no selections for scalar field '".concat(a, "'."), null, [e]);
        return {
          kind: "ScalarField",
          alias: o,
          args: s,
      ...
      var h = e.selectionSet ? this._transformSelections(e.selectionSet, m) : null;
      if (null == h || 0 === h.length) throw v("Expected at least one selection for non-scalar field '".concat(a, "' on type '").concat(String(m), "'."), null, [e]);
      return {
        kind: "LinkedField",
        alias: o,
        args: s,
      ...
      return t.forEach(function (t) {
        ...
        if (a) {
          var i,
              ...
              l = null,
              u = Q(a.value, a);
          if ("string" != typeof u) throw v("Expected a string literal argument for the @".concat("__clientField", " directive."), null, [a.value]);
          i = u;
          ...
          if (c) {
            var f = Q(c.value, c);
            if ("string" != typeof f) throw v("Expected a string literal argument for the @".concat("__clientField", " directive."), null, [c.value]);
            o = f;
          }
          ...
          if (d) {
            ...
            })) throw v("Expected an array of argument names on field '".concat(e, "'."), null, [d.value]);
            l = m;
          }
          ...
          if (null != p) throw v("Dynamic keys are only supported with @connection.", null, [p.value]);
          (r = r || []).push({
            name: i,
            key: o,
            filters: l,
      ...
      return this._validateDirectivesLocation(e, n), e.map(function (e) {
        ...
        if (null == r) throw v("Unknown directive '".concat(n, "'."), null, [e]);
      ...
      return e.map(function (e) {
        ...
        if (null == a) throw v("Unknown argument '".concat(r, "'."), null, [e]);
      ...
      return [t.map(function (e) {
        var n = "include" === e.name,
            t = e.args[0];
        if (null == t || "if" !== t.name) throw v("Expected an 'if' argument to @".concat(e.name, "."), [e.loc]);
        if ("Variable" !== t.value.kind && "Literal" !== t.value.kind) throw v("Expected the 'if' argument to @".concat(e.name, " to be a variable or literal."), [e.loc]);
        return {
          kind: "Condition",
          condition: t.value,
          loc: e.loc,
  ...
  function U(e, n, t) {
    ...
    if ("NullValue" === e.kind) {
      if (n instanceof C) throw v("Expected a value matching type '".concat(String(n), "'."), null, [e]);
      return {
        kind: "Literal",
        loc: H(e.loc),
        metadata: null,
    ...
    return function (e, n, t, r) {
      ...
      if (a instanceof x) {
        if ("ListValue" !== e.kind) return U(e, a.ofType, t, r);
        var i = k(a.ofType),
            o = [],
            l = [],
            s = !0;
      ...
      if (a instanceof F) {
        var u = a;
        if ("ObjectValue" !== e.kind) throw v("Expected a value matching type '".concat(String(n), "'."), null, [e]);
        var f = {},
            d = [],
            m = !0;
        return e.fields.forEach(function (e) {
          var a = K(e),
              i = u.getFields()[a];
          if (null == i) throw v("Uknown field '".concat(a, "' on type '").concat(String(n), "'."), null, [e]);
          var o = k(i.type),
              l = U(e.value, o, t, r);
      ...
      if (a === T) {
        ...
        throw v("Invalid value, expected a value matching type '".concat(String(n), "'."), null, [e]);
      }

      if (a instanceof E) {
        var h = a.parseLiteral(e);
        ...
        if (null == h) {
          ...
          throw v("Expected a value matching type '".concat(String(n), "'."), null, [e]);
        }
      ...
      if (a instanceof D) {
        ...
        if (null == b) throw v("Expected a value matching type '".concat(String(n), "'."), null, [e]);
        return {
          kind: "Literal",
          loc: H(e.loc),
          metadata: null,
  ...
  function Q(e, n) {
    switch (e.kind) {
      ...
      case "Variable":
        throw v("Unexpected variable where a literal (static) value is required.", null, [e, n]);
  ...
  function B(e) {
    ...
    }(e)) throw v("Expected a scalar field type, got type '".concat(String(e), "'."));
    return e;
  }
  ...
  e.exports = {
    parse: function (e, n, t) {
      ...
      return e = S(e, r, {
        assumeValid: !0
      }), new q(e, r.definitions).transform();
    },
    transform: function (e, n) {
      return o.run("RelayParser.transform", function () {
        return new q(e, n).transform();
      });
    }
  };
}, function (e, n) {
  ...
  var r = t(0),
      ...
      v = t(56),
      h = v.anyTypeAlias,
      g = v.declareExportOpaqueType,
      y = v.exactObjectTypeAnnotation,
      b = v.exportType,
      k = v.exportTypes,
      w = v.importTypes,
      S = v.intersectionTypeAnnotation,
      _ = v.lineComments,
      E = v.readOnlyArrayOfType,
      T = v.readOnlyObjectTypeProperty,
      F = v.unionTypeAnnotation,
      x = t(74),
      C = x.transformInputType,
      D = x.transformScalarType,
      A = t(11),
      N = A.getModuleComponentKey,
      L = A.getModuleOperationKey,
      R = t(75).default,
      I = t(29),
      O = t(1),
  ...
  function W(e, n, t, r) {
    ...
    var s = [];
    if (Object.keys(l).length > 0 && Q(Array.from(o.values())) && (U(Array.from(o.values())) || Object.keys(l).every(function (e) {
      return U(l[e]);
    }))) !function () {
      var e = new Set(),
          r = function (r) {
        s.push(ne([].concat((0, i.default)(Array.from(o.values())), (0, i.default)(l[r]))).map(function (a) {
          return "__typename" === a.schemaName && e.add(a.key), q(a, n, t, r);
        }));
      };
      ...
      var f = ne(Array.from(u.values())).map(function (e) {
        return G(e) && e.concreteType ? q((0, a.default)({}, e, {
          conditional: !1
        }), n, t, e.concreteType) : q(e, n, t);
      });
      s.push(f);
    }
  ...
  function B(e, n) {
    ...
    try {
      for (var v, h = n.entries()[Symbol.iterator](); !(d = (v = h.next()).done); d = !0) {
        var g = v.value;
        c = g[0], f = g[1];
    ...
    if (e.usedFragments.size > 0) {
      ...
      try {
        for (var o, l = t[Symbol.iterator](); !(r = (o = l.next()).done); r = !0) {
          var s = o.value,
              u = ae(s);
          e.generatedFragments.has(s) || (e.useHaste && e.existingFragmentNames.has(s) ? n.push(w([u], s + ".graphql")) : e.useSingleArtifactDirectory && e.existingFragmentNames.has(s) ? n.push(w([u], "./" + s + ".graphql")) : n.push(h(u)));
        }
      } catch (e) {
        a = !0, i = e;
      } finally {
        ...
        return {
          leave: {
            Root: function (t) {
              var r,
                ...
                return Object.keys(e.generatedInputObjectTypes).map(function (n) {
                  ...
                  return "string" == typeof t && j(!1), b(n, t);
                });
              }(n),
              ...
              var d,
                ...
                return null != t && "string" == typeof t ? t : null;
                  ...
                  k = [].concat((0, i.default)(h ? (m = ae(d = h), v = ie(d), [w(["FragmentReference"], "relay-runtime"), g(m, "FragmentReference"), g(v, m)]) : te(n)), (0, i.default)(re(n)), (0, i.default)(l), [o, u]);
            ...
            Fragment: function (e) {
              ...
              t = t.map(function (n) {
                return r <= 1 && G(n) && !p(e.type) ? [(0, a.default)({}, n, {
              ...
              var c = T("$fragmentRefs", I.genericTypeAnnotation(I.identifier(ae(e.name)))),
                ...
                return "".concat(e, "$data");
                  ...
                  v = null != e.metadata && !1 === e.metadata.mask,
                  h = W(t, n, v, v ? void 0 : ae(e.name)),
                  y = function (e) {
    ...
    convertASTDocumentsWithBase: function (e, n, t, a, i) {
      return r.run("ASTConvert.convertASTDocumentsWithBase", function () {
        ...
        for (l.forEach(function (e) {
          ...
          var f = c.pop(),
              v = f.name && f.name.value;
          if (v) if (s.has(v)) {
            if (s.get(v) !== f) throw new Error("Duplicate definition of '".concat(v, "'."));
          } else s.set(v, f), d(f, {
            FragmentSpread: function (e) {
      ...
      return u.asyncContext("CodegenRunner.write", a(function* () {
        try {
          ...
          s && s.forEach(function (e) {
            n.parsers[e] || c(!1), p = p.merge(n.parsers[e].documents());
          });
          var v = n.parserConfigs[a],
              h = v.baseDir,
              g = v.generatedDirectoriesWatchmanExpression,
              y = [];
          if (g) y = (yield l.queryDirectories(h, g)).map(function (e) {
            return f.join(h, e);
          });
          ...
          try {
            for (var T, F = w.values()[Symbol.iterator](); !(S = (T = F.next()).done); S = !0) {
              ...
              try {
                for (var L, R = C[Symbol.iterator](); !(D = (L = R.next()).done); D = !0) {
                  var I = L.value;
                  m(x.getPath(I)) || c(!1);
                }
              } catch (e) {
          ...
          var O = n.onComplete;
          null != O && O(Array.from(w.values()));
          var V = o.combineChanges(Array.from(w.values()));
          return o.printChanges(V, {
            onlyValidate: n.onlyValidate
          }), o.hasChanges(V) ? "HAS_CHANGES" : "NO_CHANGES";
        } catch (e) {
    ...
    find: r.instrument(function (e) {
      var n = [],
        ...
        CallExpression: function (e) {
          ...
          if ("Identifier" === t.type && l[t.name] || "MemberExpression" === t.kind && "Identifier" === t.object.type && "Relay" === t.object.value && "Identifier" === t.property.type && l[t.property.name]) {
            var a = e.arguments[1];
            "ObjectExpression" === a.type ? a.properties.forEach(function (e) {
              ("ObjectProperty" !== e.type || "Identifier" !== e.key.type || "TaggedTemplateExpression" !== e.value.type) && p(!1), c(e.value.tag) || p(!1), u(e.value.tag) && n.push({
                keyName: e.key.name,
                template: d(e.value.quasi),
                sourceLocationOffset: m(e.value.quasi)
              });
            }) : (a && "TaggedTemplateExpression" === a.type || p(!1), c(a.tag) || p(!1), n.push({
              keyName: null,
              template: d(a.quasi),
              sourceLocationOffset: m(a.quasi)
            }));

            for (var i = 2; i < e.arguments.length; i++) v(e.arguments[i], r);
          } else h(e, r);
        },
      ...
      return u.asyncContext("RelayFileWriter.writeAll", a(function* () {
        var e = function (e) {
          ...
          var n = e.baseDocuments,
              ...
              p = e.typeGenerator,
              v = o.transformASTSchema(t, d),
              h = o.extendASTSchema(v, [].concat((0, i.default)(n), (0, i.default)(a))),
          ...
          var y = o.convertASTDocumentsWithBase(h, n, a, g, c.transform),
              b = new s(t, h).addAll(y),
        ...
        var A = T.filter(function (e) {
          ...
          return !D.has(t);
            ...
            N = new Map(A.map(function (e) {
          e[0];
          var n = e[1];
          return ["Request" === n.kind ? n.params.name : n.name, n];
        })),
            L = new Set(F.map(function (e) {
          return e.name;
        })),
            R = new Map(),
            I = function (e) {
        ...
        try {
          for (var G, U = (n.generatedDirectories || [])[Symbol.iterator](); !(j = (G = U.next()).done); j = !0) {
            var Q = G.value;
            M(Q);
          }
        } catch (e) {
          ...
          yield Promise.all(A.map((W = a(function* (e) {
            ...
            if (!D.has(i)) {
              var o = x.get(i),
                ...
                return e = v.print(I(i).ast), p.createHash("md5").update(e, "utf8").digest("hex");
                var e;
              });
    ...
    getFieldDefinitionLegacy: function (e, n, t, a) {
      ...
      return i || (i = function (e, n, t, r) {
        if (c(n) && r && r.directives && r.directives.some(function (e) {
          return "fixme_fat_interface" === v(e);
        })) {
  ...
  e.exports = function (e, n, t, a) {
    return i.run("GraphQLCompiler.compile", function () {
      ...
      try {
        for (var p, v = u.documents()[Symbol.iterator](); !(f = (p = v.next()).done); f = !0) {
          var h = p.value;

          if ("Root" === h.kind) {
            var g = i.getRoot(h.name),
                y = {
              kind: "Request",
              fragment: {
                kind: "Fragment",
  ...
  function m() {
    return (m = a(function* (e, n, t, r, a, m, p, v, h) {
      var g,
      ...
      if (k.kind === f.REQUEST) {
        var F = l.run("RelayFileWriter:compareHash", function () {
          var n = e.read(_),
              t = s.createHash("md5");
          return t.update("cache-breaker-9"), t.update(JSON.stringify(k)), t.update(v), a && t.update(a), w && t.update("persisted"), T = t.digest("hex"), function (e) {
  ...
  function s(e, n) {
    ...
    if (null != p) {
      var v,
          h = s.args.find(function (e) {
        return "label" === e.name;
      }),
          g = p.args.find(function (e) {
        return "label" === e.name;
      }),
          y = null !== (v = null == g ? void 0 : g.loc) && void 0 !== v ? v : p.loc;
      throw h ? o("Invalid use of @connection_resolver, the provided label is not unique. Specify a unique 'label' as a literal string.", [null == h ? void 0 : h.loc, y]) : o("Invalid use of @connection_resolver, could not generate a default label that is unique. Specify a unique 'label' as a literal string.", [s.loc, y]);
    }
    ...
    return n.selections.forEach(function (n) {
      ...
      if (s) {
        if (i = !0, "InlineFragment" === s.kind) {
          ...
          h(n, s), e.set(o, (0, r.default)({
            kind: "LinkedField"
          }, s, {
            handles: g(s, n),
            selections: v(s, n, t, n.type)
          }));
  ...
  var r = t(0),
      ...
      v = f.GraphQLScalarType,
      h = f.GraphQLInterfaceType,
  ...
  function A(e) {
    if (e.name === C) {
      ...
      if (null != n && n instanceof v && u(e.type).name === n.name) throw new c("Direct use of the '".concat(C, "' field is not allowed, use ") + "@match/@module instead.", [e.loc]);
    }
  ...
  function N(e, n) {
    ...
    var o = n.parentType,
        l = u(o);
    if (!(l instanceof h || l instanceof p)) throw c("@match used on incompatible field '".concat(t.name, "'.") + "@match may only be used with fields whose parent type is an " + "interface or object, got invalid type '".concat(String(o), "'."), [e.loc]);
    ...
    var v = u(t.type);
    if (!(v instanceof g || v instanceof h)) throw c("@match used on incompatible field '".concat(t.name, "'.") + "@match may only be used with fields that return a union or interface.", [e.loc]);
    var w = new Map(),
        S = [];
    if (t.selections.forEach(function (e) {
      if ("ScalarField" !== e.kind || "__typename" !== e.name) {
        ...
        var r = e.typeCondition,
            a = w.get(r);
        if (a) throw c("Invalid @match selection: each concrete variant/implementor of " + "'".concat(String(v), "' may be matched against at-most once, ") + "but '".concat(String(r), "' was matched against multiple times."), [e.loc, a.loc]);
        w.set(r, e);
        var i = v instanceof g ? v.getTypes() : s.serverSchema.getPossibleTypes(v);
  ...
  function L(e, n) {
    ...
    if (null == E) return w;
    if (0 !== e.args.length) throw c("@module does not support @arguments.", [null === (h = e.args[0]) || void 0 === h ? void 0 : h.loc].filter(Boolean));
    var D = this.getContext(),
        A = D.serverSchema.getType(T);
    if (null == A || !(A instanceof v)) throw c("Using @module requires the schema to define a scalar " + "'".concat(T, "' type."));
    var N = D.getFragment(e.name, e.loc);
    if (!m(N.type)) throw c("@module used on invalid fragment spread '...".concat(e.name, "'. @module ") + "may only be used with fragments on a concrete (object) type, " + "but the fragment has abstract type '".concat(String(N.type), "'."), [e.loc, N.loc]);
    var L = d(N.type).getFields()[C],
        R = L ? L.args.find(function (e) {
      return e.name === F;
    }) : null,
        I = L ? L.args.find(function (e) {
      return e.name === x;
    }) : null;
    if (null == L || null == R || k(R.type) !== b || null != I && k(I.type) !== b || L.type.name !== A.name) throw c("@module used on invalid fragment spread '...".concat(e.name, "'. @module ") + "requires the fragment type '".concat(String(N.type), "' to have a ") + "'".concat(C, "(").concat(F, ": String! ") + "[".concat(x, ": String]): ").concat(T, "' field (your ") + "schema may choose to omit the 'id'  argument but if present it must accept a 'String').", [E.loc]);
  ...
  e.exports = {
    ...
    transform: function (e) {
      var n = e.serverSchema,
          t = n.getQueryType();
      if (null == t) throw v("Expected the schema to define a query type.");

      var r = function (e) {
        var n = new Map(),
            t = h(e.documents(), function (e) {
          if ("Fragment" === e.kind) {
            var t = function (e) {
              var n = e.directives.find(function (e) {
                return "refetchable" === e.name;
            ...
            if (null !== t) {
              var r = n.get(t);
              if (null != r) throw v("Duplicate definition for @refetchable operation '".concat(t, "' from fragments '").concat(e.name, "' and '").concat(r.name, "'"), [e.loc, r.loc]);
              n.set(t, e);
            }
          }
        });
        ...
        if (c(u.type, t)) r = function (e, n, t) {
          ...
          var r = f(e.getQueryType()),
              a = e.getType(D),
              i = r.getFields()[A];
          if (!(a instanceof T && null != i && i.type instanceof T && c(i.type, a) && 0 === i.args.length && c(n.type, a))) throw v("Invalid use of @refetchable on fragment '".concat(n.name, "', check that your schema defines a 'Viewer' object type and has a 'viewer: Viewer' field on the query type."), [n.loc]);
          return {
            path: [A],
            node: {
              argumentDefinitions: I(n.argumentDefinitions),
          ...
          if (!(String(u.type) === N || u.type instanceof T && u.type.getInterfaces().some(function (e) {
            return String(e) === N;
          }) || F(u.type) && R(u.type, n).every(function (e) {
            return x(e, N);
          }))) throw v("Invalid use of @refetchable on fragment '".concat(u.name, "', only fragments on the Query type, Viewer type, Node type, or types implementing Node are supported."), [u.loc]);
          ...
          r = function (e, n, t) {
            ...
            if (!(a instanceof S && null != o && o.type instanceof S && c(o.type, a) && 1 === o.args.length && "id" === o.args[0].name && c(k(o.args[0].type), w) && (n.type instanceof T && n.type.getInterfaces().some(function (e) {
              return c(e, a);
            }) || F(n.type) && R(n.type, e).every(function (e) {
              return e.getInterfaces().some(function (e) {
                return c(e, a);
              });
            })))) throw v("Invalid use of @refetchable on fragment '".concat(n.name, "', check that your schema defines a 'Node { id: ID }' interface and has a 'node(id: ID): Node' field on the query type (the id argument may also be non-null)."), [n.loc]);
            var l = I(n.argumentDefinitions),
                s = l.find(function (e) {
              return "id" === e.name;
            });
            if (null != s) throw v("Invalid use of @refetchable on fragment '".concat(n.name, "', this fragment already has an '$id' variable in scope."), [s.loc]);
            var u = new E(w),
        ...
        if (null != r) {
          var d,
            ...
            if (o.visit(e, {
              LinkedField: {
                enter: function (a) {
                  if (n.push(a), a.handles && a.handles.some(function (e) {
                    ...
                    if (null != t) throw v("Invalid use of @refetchable with @connection in fragment '".concat(e.name, "', at most once @connection can appear in a refetchable fragment."), [a.loc]);
                    var i = n.find(function (e) {
                      return k(e.type) instanceof _;
                    });
                    if (i) throw v("Invalid use of @refetchable with @connection in fragment '".concat(e.name, "', refetchable connections cannot appear inside plural fields."), [a.loc, i.loc]);
              ...
              if (i || l) {
                if (!i || !l || "Variable" !== i.value.kind || "Variable" !== l.value.kind) throw v("Invalid use of @refetchable with @connection in fragment '".concat(e.name, "', refetchable connections must use variables for the before and last arguments."), [t.loc, i && "Variable" !== i.value.kind ? i.value.loc : null, l && "Variable" !== l.value.kind ? l.value.loc : null].filter(Boolean));
                a = {
              ...
              if (u || c) {
                if (!u || !c || "Variable" !== u.value.kind || "Variable" !== c.value.kind) throw v("Invalid use of @refetchable with @connection in fragment '".concat(e.name, "', refetchable connections must use variables for the after and first arguments."), [t.loc, u && "Variable" !== u.value.kind ? u.value.loc : null, c && "Variable" !== c.value.kind ? c.value.loc : null].filter(Boolean));
                s = {
          ...
          l = (l = l.replace((0, a.default)({}, g, {
            ...
            metadata: (0, a.default)({}, h.metadata || {}, {
              derivedFrom: g.name,
            ...
            try {
              for (var c, f = t.argumentDefinitions.entries()[Symbol.iterator](); !(l = (c = f.next()).done); l = !0) {
                var m = c.value,
                    p = m[0],
                    v = m[1];
                "LocalArgumentDefinition" === v.kind && i.set(p, v);
              }
            } catch (e) {
              s = !0, u = e;
            } finally {
  ...
  function u(e) {
    var n = e.mask,
        t = e.plural;
    return void 0 !== t && "boolean" != typeof t && o(!1), void 0 !== n && "boolean" != typeof n && o(!1), {
      mask: n,
      plural: t
    };
  }
  ...
  function c(e) {
    var n = e.mask;
    return void 0 !== n && "boolean" != typeof n && o(!1), {
      mask: n
    };
  }
  ...
  var r = t(76),
    ...
    flattenAbstractTypes: !0
      ...
      A = [c.transform, v.transform, d.transform, _.transform],
      N = [F.transform, S.transform, s.transform, r.transform, o.transformWithOptions({
    flattenAbstractTypes: !0
  }), T.transform, h.transform, i.transform, u.transformWithOptions({
    removeUnusedVariables: !1
  })],
      L = [r.transform, E.transform, F.transform, o.transformWithOptions({}), h.transform, w.transform, i.transform, u.transformWithOptions({
  ...
  var l = function () {
    ...
    return n.getContext = function () {
      ...
      n && n.forEach(function (n) {
        var t = e[n];
        t && (Array.isArray(t) || r(!1), t.forEach(function (e) {
          return a._visit(e);
        }));
      }), t && t.forEach(function (n) {
        var t = e[n];
    ...
    function o(e, t) {
      ...
      return n(o, e, t).forEach(function (e) {
        var n = new i.Source(e, t.relPath),
            a = f(n);
        a.definitions.length || s(!1), d.push(n.body), c.push.apply(c, (0, r.default)(a.definitions));
      }), {
        document: {
          kind: "Document",
          definitions: c
  ...
  var r = t(20),
      ...
      q = t(46),
      G = q.getReaderSourceDefinitionName,
      U = q.getSourceDefinitionName,
      Q = F(c.find);
  ...
  e.exports = {
    ...
    getIdentifierForArgumentValue: L,
    getNormalizationOperationName: I,
    getLiteralArgumentValues: R,
    isEquivalentType: O,
    nullthrows: V,
    Parser: T,
    Validator: x,
    ...
    getReaderSourceDefinitionName: G,
    getSourceDefinitionName: U,
        ...
        case "LinkedField":
          n.push.apply(n, (0, i.default)(function (e) {
            var n = e.handles && e.handles.map(function (n) {
              ...
              storageKey: null,
              args: k(e.args),
              concreteType: h(t) ? null : t.toString(),
              plural: b(e.type),
              selections: y(e.selections)
            },
                i = S(r, e.metadata);
  ...
  function g(e, n, t) {
    if (e instanceof f) return o(h(e.ofType, n, t));
    if (e instanceof m || e instanceof v || e instanceof c) return t;
        ...
        switch (n.kind) {
          ...
          case "LinkedField":
            ...
            if ("ScalarField" === n.kind) p.push(n);else {
              var s,
                  f = o(n.type),
                  v = null !== (s = c.getType(f.name)) && void 0 !== s ? s : d.getType(f.name);
              if (null == v) throw u("ClientExtensionTransform: Expected to be able to determine " + "type of field `".concat(n.name, "`."), [n.loc]);
              var h = e(n, t, v);
              p.push(h);
            }
            break;
        ...
        return function (e, n) {
          var t = n.removeUnusedVariables,
            ...
            if ("Root" === e.kind) {
              ...
              try {
                for (var p, v = o.values()[Symbol.iterator](); !(f = (p = v.next()).done); f = !0) {
                  var h = p.value;
                  a.has(h.name) || s.push(h);
                }
              } catch (e) {
                d = !0, m = e;
              } finally {
  ...
  function h(e, n, t, r, o) {
    var l = y(t, r.directives, o),
      ...
      var h = m(c.argumentDefinitions, o, t, r);
      n.set(p, {
        kind: "pending"
      });
      var y = null,
          b = g(e, n, h, c.selections, l);
      b && (y = (0, a.default)({}, c, {
        selections: b,
        name: p,
        argumentDefinitions: []
  ...
  function g(e, n, t, r, o) {
    ...
    return r.forEach(function (r) {
      var s;
      if ("ClientExtension" === r.kind || "InlineDataFragmentSpread" === r.kind || "InlineFragment" === r.kind || "ModuleImport" === r.kind) s = v(e, n, t, r, o);else if ("FragmentSpread" === r.kind) s = h(e, n, t, r, o);else if ("Condition" === r.kind) {
        var u,
  ...
  function I(e, n) {
    ...
    !function (e) {
      var n = C.get().EDGES;
      if (!O(e, h) && !O(e, y)) throw d("Expected field '".concat(e.name, "' to have a '").concat(h, "' or '").concat(y, "' ") + "argument.", [e.loc]);
      ...
      var r = t.name,
          ...
          h = n.getFields(),
          g = h[o];
      if (null == g) throw d("@".concat(r, " used on invalid field '").concat(e.name, "'. Expected the ") + "field type '".concat(v, "' to have an '").concat(o, "' field"), [e.loc]);
      var y = s.getNullableType(g.type);
      if (!(y instanceof w)) throw d("@".concat(r, " used on invalid field '").concat(e.name, "'. Expected the ") + "field type '".concat(v, "' to have an '").concat(o, "' field that returns ") + "a list of objects.", [e.loc]);
      var b = s.getNullableType(y.ofType);
      if (!(b instanceof S || b instanceof k)) throw d("@".concat(r, " used on invalid field '").concat(e.name, "'. Expected the ") + "field type '".concat(v, "' to have an '").concat(o, "' field that returns ") + "a list of objects.", [e.loc]);
      var E = b.getFields()[f];
      if (null == E) throw d("@".concat(r, " used on invalid field '").concat(e.name, "'. Expected the ") + "field type '".concat(v, "' to have an '").concat(o, " { ").concat(f, " }' field ") + "that returns an object, interface, or union.", [e.loc]);
      var F = s.getNullableType(E.type);
      if (!(F instanceof k || F instanceof T || F instanceof S)) throw d("@".concat(r, " used on invalid field '").concat(e.name, "'. Expected the ") + "field type '".concat(v, "' to have an '").concat(o, " { ").concat(f, " }' field ") + "that returns an object, interface, or union.", [e.loc]);
      var x = b.getFields()[i];
      if (null == x || !(s.getNullableType(x.type) instanceof _)) throw d("@".concat(r, " used on invalid field '").concat(e.name, "'. Expected the ") + "field type '".concat(v, "' to have an '").concat(o, " { ").concat(i, " }' field ") + "that returns a scalar value.", [e.loc]);
      var D = h[m];
      if (null == D) throw d("@".concat(r, " used on invalid field '").concat(e.name, "'. Expected the ") + "field type '".concat(v, "' to have a '").concat(m, "' field that returns ") + "an object.", [e.loc]);
      var A = s.getNullableType(D.type);
      if (!(A instanceof S)) throw d("@".concat(r, " used on invalid field '").concat(e.name, "'. Expected the ") + "field type '".concat(v, "' to have a '").concat(m, "' field that ") + "returns an object.", [e.loc]);
      [l, u, c, p].forEach(function (n) {
        var t = A.getFields()[n];
        if (null == t || !(s.getNullableType(t.type) instanceof _)) throw d("@".concat(r, " used on invalid field '").concat(e.name, "'. Expected ") + "the field type '".concat(v, "' to have a '").concat(m, " { ").concat(n, " }' ") + "field returns a scalar.", [e.loc]);
      });
    }(m, r, b);
    ...
    var x = function (e, n) {
      ...
      if (null != r && "string" != typeof r) {
        ...
        throw d("Expected the ".concat(L, " argument to @").concat(n.name, " to ") + "be a string literal for field ".concat(e.name, "."), [null !== (l = null == c ? void 0 : null === (s = c.value) || void 0 === s ? void 0 : s.loc) && void 0 !== l ? l : n.loc]);
      }
      ...
      if (!a.endsWith("_" + v)) {
        ...
        throw d("Expected the ".concat(g, " argument to @").concat(n.name, " to be of ") + "form <SomeName>_".concat(v, ", got '").concat(a, "'. ") + "For a detailed explanation, check out https://relay.dev/docs/en/pagination-container#connection", [null !== (h = null == b ? void 0 : null === (y = b.value) || void 0 === y ? void 0 : y.loc) && void 0 !== h ? h : n.loc]);
      }
      ...
      if (n.name === N) {
        ...
        if (null != i && "string" != typeof i) {
          ...
          throw d("Expected the 'label' argument to @".concat(n.name, " to be a string literal for field ").concat(e.name, "."), [null !== (R = null == O ? void 0 : null === (I = O.value) || void 0 === I ? void 0 : I.loc) && void 0 !== R ? R : n.loc]);
        }
      ...
      var r = n.includes(null),
          ...
          l = null,
          s = null;
      a && !i ? (o = "forward", l = a, s = O(e, p)) : i && !a ? (o = "backward", l = i, s = O(e, v)) : i && a && (o = "bidirectional");
    ...
    if (null != V) {
      var M = function (e, n, t, r, o, u) {
        ...
        var M = F(O),
            j = l.transform(e.clientSchema, [M.definitions[0]])[0];
        if ("LinkedField" !== L.kind) throw f("RelayConnectionTransform: Expected generated pageInfo selection to be a LinkedField", [n.loc]);
        L = (0, a.default)({}, L, {
          selections: [].concat((0, i.default)(L.selections), [{
            directives: [],
            kind: "InlineFragment",
            loc: h,
            metadata: null,
            typeCondition: j.type,
        ...
        var P = "\n    fragment Edges on ".concat(String(s.getRawType(R)), " {\n      ").concat(b, "\n      ").concat(T, ' {\n        __typename # rely on GenerateRequisiteFieldTransform to add "id"\n      }\n    }\n  '),
            q = F(P),
            G = l.transform(e.clientSchema, [q.definitions[0]])[0];
        N = (0, a.default)({}, N, {
          directives: null != p ? [].concat((0, i.default)(N.directives), [p]) : N.directives,
        ...
        var U = n.selections.map(function (e) {
          return null != N && null != c && e === c ? N : null != L && null != m && e === m ? L : e;
        });
        null == c && null != N && U.push(N);
        null == m && null != L && U.push(L);
        return U;
  ...
  function s(e, n) {
    ...
    var v = null !== (t = d(u, "label")) && void 0 !== t ? t : e.alias,
        h = m(n.documentName, "stream", v);
    return n.recordLabel(h, u), {
  ...
  function _(e, n) {
    ...
    var r = this.getContext().serverSchema,
        o = f(p(e.type));
    if (m(o) && h(r, o)) return (0, a.default)({}, t, {
    ...
    if (y(o)) {
      ...
      return r.getPossibleTypes(d).forEach(function (e) {
        !g(e, S) && h(r, e) && l.push(E(e, n.idField));
      }), (0, a.default)({}, t, {
        selections: l
      });
    }
        ...
        Root: function (t) {
          return function e(n, t, r) {
            for (var o, f, d = (0, i.default)(r.selections); d.length;) {
              ...
              switch (m.kind) {
                case "Condition":
                  var v = "Variable" === (f = m).condition.kind ? c : f.condition.value === f.passingValue ? u : s;
                  v === u ? d.unshift.apply(d, (0, i.default)(m.selections)) : v === c && (p = e(n, t, m));
                  break;

                case "FragmentSpread":
                  if (!t.has(m.name)) {
                    var h = n.getFragment(m.name),
                        g = e(n, t, h);
                    t.set(m.name, g);
                  }
      ...
      return function (e, n, t) {
        ...
        i.parse(new i.Source(r, t, o)).definitions.forEach(function (e) {
          if ("OperationDefinition" === e.kind) {
            ...
            r && t.startsWith(n) || c(!1);
          } else if ("FragmentDefinition" === e.kind) {
            var i = e.name.value;
            null != a ? i !== n + "_" + a && c(!1) : i.startsWith(n) || c(!1);
          }
        });
      }(e, o, t);
    }), r.map(function (e) {
  ...
  e.exports = {
    ...
    memoizedFind: function (e, n, t, r) {
      return r.exists || c(!1), s.getOrCompute(r.hash, u.bind(null, e, n, o.join(t, r.relPath)));
    }
  };
}, function (e, n, t) {
  "use strict";
  ...
  function getCodegenRunner(e) {
    var n,
      ...
      exclude: [path.relative(e.src, e.schema)].concat(e.exclude)
        ...
        h = (n = {}, (0, _defineProperty2.default)(n, s, {
      baseDir: e.src,
      ...
      watchmanExpression: e.watchman ? buildWatchExpression(v) : null,
      filepaths: e.watchman ? null : getFilepathsFromGlob(e.src, v)
    }), n),
  ...
  function getRelayFileWriter(e, n, t, r, a, i, o) {
    return function () {
      var l = _asyncToGenerator(function* (l) {
        ...
        if (null != o || null != a) {
          u = new Map();
          var h = o || defaultPersistFunction;

          s = function () {
            var e = _asyncToGenerator(function* (e) {
              var n = yield h(e);
              return "string" != typeof n && invariant(!1), u.set(n, e), n;
            });
